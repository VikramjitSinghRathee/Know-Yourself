...
public class Main4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this,"the shared preference name is "+"scale_value_"+formattedDate, Toast.LENGTH_LONG).show();
        editor = sharedPreferences.edit();
        editor.clear();
        editor.apply();
        old_scale_value = sharedPreferences.getInt("sad",0);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.imageButton1:
                ...
                cur_value = sharedPreferences.getInt("sad",0);
